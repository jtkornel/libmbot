...
Libmbot has an object representation of devices connected the Makeblock Arduino boards, with set and get operations that encapsulate communication with each device, as if they were connected directly to your host machine. It allows writing functionality on host without updating the mbot firmware. For now it supports communicating with the standard Makeblock firmware.
